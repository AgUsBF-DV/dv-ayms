...
echo ""
echo "Para ejecutar la configuración completa, ejecuta: bash scripts/linux/setup.sh"
echo "Para iniciar el servidor de desarrollo, ejecuta: bash scripts/linux/dev.sh"
