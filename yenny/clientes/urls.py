...
from .views import ClienteListView, ClienteCreateView, ClienteUpdateView, ClienteDeleteView, ClienteShowView
...
urlpatterns = [
    ...
    path('ver/<int:pk>/', ClienteShowView.as_view(), name='cliente-show'),
]
