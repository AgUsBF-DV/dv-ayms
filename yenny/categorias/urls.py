...
from .views import CategoriaListView, CategoriaCreateView, CategoriaUpdateView, CategoriaDeleteView, CategoriaShowView
...
urlpatterns = [
    ...
    path('ver/<int:pk>/', CategoriaShowView.as_view(), name='categoria-show'),
]
